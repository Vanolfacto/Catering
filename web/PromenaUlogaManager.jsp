<%-- 
    Document   : PromenaUlogaManager
    Created on : Jun 22, 2024, 9:34:39 PM
    Author     : Vanja
--%>
...
<html>
    ...
    <body>
        ...
        <form action="PromenaUlogaManager" method="post">
    <h2>Promena Uloge Menadžera</h2>
    <label for="userIdM">Menadžer ID:</label>
    <input type="text" id="userIdM" name="userIdM" required>

    <label for="novaUlogaM">Nova Uloga:</label>
    <select id="novaUlogaM" name="novaUlogaM" required>
