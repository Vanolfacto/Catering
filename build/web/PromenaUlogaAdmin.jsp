<%-- 
    Document   : PromenaUlogaAdmin
    Created on : Jun 22, 2024, 9:35:46 PM
    Author     : Vanja
--%>
...
<html>
    ...
    <body>
        ...
        <form action="PromenaUlogaAdmin" method="post">
    <h2>Promena Uloge Administratora</h2>
    <label for="userIdA">Administrator ID:</label>
    <input type="text" id="userIdA" name="userIdA" required>

    <label for="novaUlogaA">Nova Uloga:</label>
    <select id="novaUlogaA" name="novaUlogaA" required>
